...
public abstract class FeatureTiles {
    ...
    public FeatureIndexResults queryIndexedFeatures2(BoundingBox daoBoundBox)
    {
        BoundingBox expandedQueryBoundingBox = expandBoundingBox(daoBoundBox);
        return indexManager.query(expandedQueryBoundingBox, featureDao.getProjection());
    }
